...
class ManageDoctor extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.language !== this.props.language) {
            let dataSelect = this.buildDataInputSelect(this.props.allDoctors, 'USERS');
            let { resPrice, resPayment, resProvince, resSpecialty, resClinic } = this.props.allDoctorInfor;
    ...
    handleChange = async (selectedDoctor) => {
        ...
        if (res && res.errCode === 0 && res.data && res.data.Markdown) {
            ...
            let addressClinic = '', nameClinic = '', note = '', paymentId = '',
                provinceId = '', priceId = '', specialtyId = '', clinicId;
    ...
    handleChangeSelectedDoctorInfor = async (selectedDoctor, name) => {
    ...
    handleSaveContentMarkdown = () => {
        ...
        this.props.saveDoctorInforRedux({
        ...
        return (
            <div className='manage-doctor-container'>
                ...
                <button
                    ...
                    className={hasOldData === true ? 'edit-content-doctor' : 'save-content-doctor'}>
                    {hasOldData === true ?
                        <span><FormattedMessage id="admin.manage-doctor.change-infor" /></span>
                        :
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        fetchAllDoctorsRedux: () => dispatch(actions.fetchAllDoctorsRedux()),
        saveDoctorInforRedux: (data) => dispatch(actions.saveDoctorInforRedux(data))
    };
};
