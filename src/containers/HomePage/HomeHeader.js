                ...
                <div className='home-header-container'>
                    <div className='home-header-content'>
                        ...
                        <div className='right-content'>
                            ...
                            <div className={language === LANGUAGES.VI ? 'lang-vn active' : 'lang-vn'}><span onClick={() => this.changeLang(LANGUAGES.VI)}>VN</span></div>
                            <div className={language === LANGUAGES.EN ? 'lang-en active' : 'lang-en'}><span onClick={() => this.changeLang(LANGUAGES.EN)}>EN</span></div>
                        </div>
                    </div>
                </div>
                {this.props.isShowBannner === true &&
