...
const adminReducer = (state = initialState, action) => {
    switch (action.type) {
        case actionTypes.FETCH_DENDER_START:
            let copyState = { ...state };
            copyState.isLoadingGender = true;
            return {
                ...copyState,
            }
        case actionTypes.FETCH_DENDER_SUCCESS:
        ...
        case actionTypes.FETCH_DENDER_FAILDED:
            state.isLoadingGender = false;
            state.genders = [];
            return {
                ...state,
        ...
        case actionTypes.FETCH_ALLCODE_SCHEDULE_TIME_SUCCESS:
            state.allScheduleTime = action.dataAllcodeSchedule;
        ...
        case actionTypes.FETCH_REQUIRED_DOCTOR_INFOR_SUCCESS:
            state.allDoctorInfor = action.dataDoctorInfor;
